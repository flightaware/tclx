...
# implied warranty.
#------------------------------------------------------------------------------
# $Id: Config.mk,v 2.35 1993/11/07 23:58:23 markd Exp markd $
#------------------------------------------------------------------------------
...
TCL_UCB_LIB=${bldbasedir}/../tcl7.2
TCL_UCB_SRC=${srcbasedir}/../tcl7.2
...
TK_BUILD=WISHX
TK_UCB_LIB=${bldbasedir}/../tk3.5
TK_UCB_SRC=${srcbasedir}/../tk3.5
