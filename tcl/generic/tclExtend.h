 ...
 * implied warranty.
 *-----------------------------------------------------------------------------
 * $Id: tclExtend.h,v 8.10 1997/11/28 20:41:05 markd Exp $
 *-----------------------------------------------------------------------------
 */
...
#define TCLX_VERSION        "8.0.2"
#define TCLX_FULL_VERSION   "8.0.2"

#define TKX_VERSION         "8.0.2"
#define TKX_FULL_VERSION    "8.0.2"
