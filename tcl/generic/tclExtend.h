 ...
 * implied warranty.
 *-----------------------------------------------------------------------------
 * $Id: tclExtend.h,v 8.8 1997/09/22 15:17:18 markd Exp $
 *-----------------------------------------------------------------------------
 */
...
#define TCLX_VERSION        "8.0.1"
#define TCLX_FULL_VERSION   "8.0.1"

#define TKX_VERSION         "8.0.1"
#define TKX_FULL_VERSION    "8.0.1"
